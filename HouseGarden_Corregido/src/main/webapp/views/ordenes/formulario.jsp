...
<div class="container">
    ...
    <div class="card">
        <form action="${pageContext.request.contextPath}/ordenes" method="post">
            ...
            <%-- Lista desplegable de clientes cargada desde la base de datos --%>
            ...
            <div class="form-group">
                ...
                <select id="estado" name="estado" class="form-control">
                    ...
                    <option value="Completado" <c:if test="${orden.estado == 'Completado'}">selected</c:if>>Completado</option>
                    <option value="Cancelado"  <c:if test="${orden.estado == 'Cancelado'}">selected</c:if>>Cancelado</option>
                </select>
            </div>
...
<footer>&copy; 2026 HouseGarden &mdash; SENA &mdash; Laura Cómbita</footer>
</body>
</html>
